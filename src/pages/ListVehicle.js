                        ...
                        {vehicles.map((data, idx) => {
                            return (
                                <div className='col-md-3'>
                                    <div className='position-relative mb-2 rounded border border-2 border-dark'>
                                        <img className='img-fluid rounded ' src={defaultvehicle} alt={data.name} />
                                        <div className='position-absolute rounded bottom-0 start-0 bg-white px-3 py-2'>
                                            <div>{data.name} </div>
